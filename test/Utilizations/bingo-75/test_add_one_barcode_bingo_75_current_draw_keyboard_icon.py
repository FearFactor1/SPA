# Добавить один билет на утилизацию по игре бинго 75 с помощью экранной клавиатуры картинки калькулятора


def test_add_one_barcode_bingo_75_current_draw_keyboard_icon(app, fixture_barcode_bingo75):
