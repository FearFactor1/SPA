# Добавить два билет на утилизацию по игре бинго 75 с помощью экранной клавиатуры картинки калькулятора


def test_add_two_barcode_bingo_75_current_draw_keyboard_icon_range(app,
    ...
    app.utiliz.click_keyboard_icon()
    app.utiliz.modal_one_input_ticket_barcode_keyboard_icon(fixture_barcode_bingo75)
    app.utiliz.modal_draw_ok_icon()
    app.utiliz.click_keyboard_icon_2()
    app.utiliz.modal_two_input_ticket_barcode_keyboard_icon(fixture_barcode_bingo75_2)
    app.utiliz.modal_draw_ok_icon()
