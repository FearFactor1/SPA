# Жилищная лотерея + Результаты тиража + предыдущий тираж к примеру 2000



def test_housinglottery_results_draw_previous_draw(app):
    ...
    app.ResultAndPrizes.message_id_33_housinglottery_results_draw_2000()
