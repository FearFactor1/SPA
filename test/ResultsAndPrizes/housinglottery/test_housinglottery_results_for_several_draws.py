# жилищная лотерея + Результаты нескольких тиражей



def test_housinglottery_results_for_several_draws(app):
    ...
    app.ResultAndPrizes.message_id_33_housinglottery_results_for_5_draws()
