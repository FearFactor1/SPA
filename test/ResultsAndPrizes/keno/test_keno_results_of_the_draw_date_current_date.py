# Кено + Результаты тиража по дате + текущая дата



def test_keno_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_keno_results_draw_date_current_date()
