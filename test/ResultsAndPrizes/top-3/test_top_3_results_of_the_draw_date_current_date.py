# Топ-3 + Результаты тиража по дате + текущая дата



def test_top_3_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_top_3_results_draw_date_current_date()
