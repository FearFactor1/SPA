# Топ-3 + Результаты тиража по дате + за предыдущий месяц с 10го



def test_top_3_results_draw_date_previous_date(app):
    ...
    app.ResultAndPrizes.message_id_33_top_3_results_draw_date_previous_date()
