# Бинго 75 + Результаты тиража по дате + текущая дата



def test_bingo75_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_bingo75_results_draw_date_current_date()
