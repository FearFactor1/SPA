# зодиак + Результаты тиража по дате + текущая дата



def test_zodiac_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_zodiac_results_draw_date_current_date()
