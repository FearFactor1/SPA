# 12/24 + Результаты тиража по дате + за предыдущий месяц с 10го



def test_12_24_results_draw_date_previous_date(app):
    ...
    app.ResultAndPrizes.message_id_33_12_24_results_draw_date_previous_date()
