# 4из20 + Результаты тиража по дате + текущая дата



def test_4x20_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_4x20_results_draw_date_current_date()
