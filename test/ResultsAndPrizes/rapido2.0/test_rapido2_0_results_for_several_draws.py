# рапидо 2.0 + Результаты нескольких тиражей



def test_rapido2_0_results_for_several_draws(app):
    ...
    app.ResultAndPrizes.message_id_33_rapido2_0_results_for_5_draws()
