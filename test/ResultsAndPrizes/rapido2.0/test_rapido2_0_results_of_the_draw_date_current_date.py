# рапидо 2.0 + Результаты тиража по дате + текущая дата



def test_rapido2_0_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_rapido2_0_results_draw_date_current_date()
