# «Русское лото Экспресс» + Результаты нескольких тиражей



def test_russianlotto_express_results_for_several_draws(app):
    ...
    app.ResultAndPrizes.message_id_33_russianlotto_express_results_for_5_draws()
