# «Русское лото Экспресс» + Результаты тиража по дате + текущая дата



def test_russianlotto_express_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_russianlotto_express_results_draw_date_current_date()
