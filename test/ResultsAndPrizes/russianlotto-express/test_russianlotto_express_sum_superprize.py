# «Русское лото Экспресс» + Сумма суперприза



def test_russianlotto_express_sum_superprize(app):
    ...
    app.ResultAndPrizes.message_id_33_russianlotto_express_superprizes()
