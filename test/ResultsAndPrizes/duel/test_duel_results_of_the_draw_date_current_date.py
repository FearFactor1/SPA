# Дуэль + Результаты тиража по дате + текущая дата



def test_duel_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_duel_results_draw_date_current_date()
