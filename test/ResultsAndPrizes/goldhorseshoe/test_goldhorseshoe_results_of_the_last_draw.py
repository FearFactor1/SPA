# Золотая подкова + Результаты последнего тиража



def test_goldhorseshoe_results_last_draw(app):
    ...
    app.ResultAndPrizes.message_id_33_goldhorseshoe_results_last_draw()
