# Золотая подкова + Результаты тиража + предыдущий тираж к примеру 1600



def test_goldhorseshoe_results_draw_previous_draw(app):
    ...
    app.ResultAndPrizes.message_id_33_goldhorseshoe_results_draw_1600()
