# Золотая подкова + Результаты тиража по дате + за предыдущий месяц с 10го



def test_goldhorseshoe_results_draw_date_previous_date(app):
    ...
    app.ResultAndPrizes.message_id_33_goldhorseshoe_results_draw_date_previous_date()
