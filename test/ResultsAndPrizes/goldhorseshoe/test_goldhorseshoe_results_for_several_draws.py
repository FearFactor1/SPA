# Золотая подкова + Результаты нескольких тиражей



def test_goldhorseshoe_results_for_several_draws(app):
    ...
    app.ResultAndPrizes.message_id_33_goldhorseshoe_results_for_5_draws()
