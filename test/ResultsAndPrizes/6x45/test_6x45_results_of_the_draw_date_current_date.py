# 6из45 + Результаты тиража по дате + текущая дата



def test_6x45_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_6x45_results_draw_date_current_date()
