# 6из45 + Результаты тиража по дате + за предыдущий месяц с 10го



def test_6x45_results_draw_date_previous_date(app):
    ...
    app.ResultAndPrizes.message_id_33_6x45_results_draw_date_previous_date()
