# русское лото + Результаты нескольких тиражей



def test_russianlotto_results_for_several_draws(app):
    ...
    app.ResultAndPrizes.message_id_33_russianlotto_results_for_5_draws()
