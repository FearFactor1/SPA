# Русское лото + Результаты тиража по дате + текущая дата



def test_russianlotto_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_russianlotto_results_draw_date_current_date()
