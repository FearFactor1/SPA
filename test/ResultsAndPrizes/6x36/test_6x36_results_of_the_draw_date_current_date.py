# 6 из 36 + Результаты тиража по дате + текущая дата



def test_6x36_results_draw_date_current_date(app):
    ...
    app.ResultAndPrizes.message_id_33_6x36_results_draw_date_current_date()
