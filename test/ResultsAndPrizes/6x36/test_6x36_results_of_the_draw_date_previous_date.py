# 6 из 36 + Результаты тиража по дате + за предыдущий месяц с 10го




def test_6x36_results_draw_date_previous_date(app):
    ...
    app.ResultAndPrizes.message_id_33_6x36_results_draw_date_previous_date()
