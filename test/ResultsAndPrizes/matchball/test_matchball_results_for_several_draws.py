# matchball + Результаты нескольких тиражей



def test_matchball_results_for_several_draws(app):
    ...
    app.ResultAndPrizes.message_id_33_matchball_results_for_5_draws()
