...
def test_win_check_in_main_page_depressive(app2, ticketid):
    ...
    assert app2.login.press_unique_key_depressive(ticketid) == app2.login.send_message_id_50_sum_win_depressive(ticketid)
