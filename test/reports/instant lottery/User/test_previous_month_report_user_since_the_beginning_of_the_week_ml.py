# Отчет с начала недели + с галочкой Кассовый отчёт + Моментальные + Пользователь + за предыдущий месяц с 10го
import pytest



@pytest.mark.parametrize('report_type', ["520"])
def test_previous_month_report_user_since_the_beginning_of_the_week_ml(app, report_type):
