...
def test_previous_month_full_report_user_ml(app):
    ...
    assert app.report.previous_month_C_day_10() in app.report.parser_full_report_text_for_instant_game()
    assert app.report.previous_month_Po_day_10() in app.report.parser_full_report_text_for_instant_game()
