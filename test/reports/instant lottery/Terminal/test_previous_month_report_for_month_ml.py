# Отчёт за месяц + с галочкой Кассовый отчёт + Моментальные + Терминал + предыдущий месяц, к примеру будет 1 число
import pytest



@pytest.mark.parametrize('report_type', ["1031"])
def test_previous_month_report_for_month_ml(app, report_type):
