# Отчет с начала недели + без галочки Кассовый отчёт + Обычные + Терминал + за предыдущий месяц



def test_previous_month_full_report_since_the_beginning_of_the_week(app):
