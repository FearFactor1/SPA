# Отчёт за месяц + с галочкой Кассовый отчёт + Типографские + Терминал + предыдущий месяц, к примеру будет 1 число



def test_previous_month_report_for_month_tlb(app):
