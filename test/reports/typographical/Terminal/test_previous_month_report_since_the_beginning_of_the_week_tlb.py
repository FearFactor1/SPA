# Отчет с начала недели + с галочкой Кассовый отчёт + Типографские + Терминал + за предыдущий месяц с 10го



def test_report_since_the_beginning_of_the_week_previous_month_tlb(app):
