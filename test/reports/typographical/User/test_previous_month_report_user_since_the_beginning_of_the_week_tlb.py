# Отчет с начала недели + с галочкой Кассовый отчёт + Типографские + Пользователь + за предыдущий месяц с 10го



def test_previous_month_report_user_since_the_beginning_of_the_week_tlb(app):
