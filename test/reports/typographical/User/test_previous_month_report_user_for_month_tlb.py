# Отчёт за месяц + с галочкой Кассовый отчёт + Типографские + Пользователь + предыдущий месяц, к примеру будет 1 число



def test_previous_month_report_user_for_month_tlb(app):
