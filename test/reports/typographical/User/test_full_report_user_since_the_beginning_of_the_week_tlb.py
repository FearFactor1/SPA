# Отчет с начала недели + без галочки Кассовый отчёт + Типографские + Пользователь + Текущая неделя



def test_full_report_user_since_the_beginning_of_the_week_tlb(app):
