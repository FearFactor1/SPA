# Отчёт за день + без галочки Кассовый отчёт + Типографские + Пользователь + Текущая дата



def test_full_report_today_user_tlb(app):
    ...
    assert app.report.current_day_C() in app.report.parser_full_report_text_for_typographical()
