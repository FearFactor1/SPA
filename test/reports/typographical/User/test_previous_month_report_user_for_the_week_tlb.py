# Отчет за неделю + с галочкой Кассовый отчёт + Типографские + Пользователь + за предыдущий месяц с 10го


def test_previous_month_report_user_for_the_week_tlb(app):
